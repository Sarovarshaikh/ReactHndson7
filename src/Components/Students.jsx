        ...
        <>
          ...
          <div className="tab">
            <table className="table table-bordered">
              <thead>
                <tr className="neeeee fw-bold fs-4">
                  <th>Name</th>
                  <th>Age</th>
                  <th>Course</th>
                  <th>Batch</th>
      ...
      {hide ? (
        <div>
          ...
          <div className="twobtn">
            <button onClick={addData} className="btn btn-success button rounded-pill">
              {edit ? "Update" : "Submit 👍"}
            </button>
            <button onClick={clearData} className="btn btn-danger button rounded-pill :smile">
              Clear 👎
            </button>
          </div>
        </div>
